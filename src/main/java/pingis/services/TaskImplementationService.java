...
public class TaskImplementationService {
    ...
    public TaskImplementation createEmpty(User user, Task task) {
        TaskImplementation newTaskImplementation = new TaskImplementation(user, "", task);
        return taskImplementationRepository.save(newTaskImplementation);
